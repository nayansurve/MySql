...
INSERT INTO questionbank(subjectid, title, a, b, c, d, answerkey, eGetTestEmployeeDetailsByCandidatevaluationcriteriaid) VALUES(6,'What is the best practice to isolate connection string while using asp.net core application?','appsettings.json ','web.config','package.json','web.xml','a','3');
